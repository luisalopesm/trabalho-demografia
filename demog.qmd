...
$$
TMI = \frac{D_{<1}}{NV} \times 1000
$$

em que:

- $D_{<1}$ representa o número de óbitos de menores de 1 ano;
- $NV$ representa o número de nascidos vivos.

$Taxa\ de\ Mortalidade\ Infantil\ Neonatal$

$$
TMI_{neo} = \frac{D_{0-27}}{NV} \times 1000
$$

em que:

- $D_{0-27}$ representa o número de óbitos entre 0 e 27 dias de vida;
- $NV$ representa o número de nascidos vivos.

$Taxa\ de\ Mortalidade\ Infantil\ Precoce$

$$
TMI_{prec} = \frac{D_{0-6}}{NV} \times 1000
$$

em que:

- $D_{0-6}$ representa o número de óbitos entre 0 e 6 dias de vida;
- $NV$ representa o número de nascidos vivos.

$Taxa\ de\ Mortalidade\ Infantil\ Tardia$

$$
TMI_{tardia} = \frac{D_{7-27}}{NV} \times 1000
$$

em que:

- $D_{7-27}$ representa o número de óbitos entre 7 e 27 dias de vida;
- $NV$ representa o número de nascidos vivos.

$Taxa\ de\ Mortalidade\ Infantil\ Posneonatal$

$$
TMI_{pos} = \frac{D_{28-364}}{NV} \times 1000
$$

em que:

- $D_{28-364}$ representa o número de óbitos entre 28 e 364 dias de vida;
- $NV$ representa o número de nascidos vivos.
...
$$
TMP = \frac{OF + D_{0-6}}{NV + OF} \times 1000
$$

em que:

- $OF$ representa o número de óbitos fetais;
- $D_{0-6}$ representa o número de óbitos neonatais precoces (0 a 6 dias de vida);
- $NV$ representa o número de nascidos vivos.
