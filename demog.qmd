...
![](Rplot04.png)b) Supondo população fechada (inexistência de migração), calcule a probabilidade de um recém-nascido na UF ou no território de escolha sobreviver à idade exata de 5 para as coortes de 2000 a 2019.

![](Rplot06.png)**Resposta:**
...
**Resposta:**![](Rplot07.png)d) Para os anos de 2022 e 2023, calcule a probabilidade de morrer antes de completar o primeiro aniversário, segundo raça/cor (Desafio)
